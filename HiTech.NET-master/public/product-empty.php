                                ...
                                <form>
                                    ...
                                    <fieldset class="form-group bg-light p-4">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="titre" value="#">
                                            </div>
                                        </div>
                                        <!-- Image -->
                                        <div class="form-group row mb-3">
                                    ...
                                    <fieldset class="form-group bg-light p-4">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label for="titre-2"
                                                class="col-sm-2 col-form-label font-weight-bold">Titre</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="titre-2" value="#">
                                            </div>
                                        </div>
                                        <!-- Image -->
                                        <div class="form-group row mb-3">
                                    ...
                                    <fieldset class="form-group bg-light p-4">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label for="titre-3"
                                                class="col-sm-2 col-form-label font-weight-bold">Titre</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="titre-3" value="#">
                                            </div>
                                        </div>
                                        <!-- Image -->
                                        <div class="form-group row mb-3">
